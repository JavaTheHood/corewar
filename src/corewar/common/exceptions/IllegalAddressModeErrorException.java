...
/**
 * Exception class for an illegal address mode of an RedCodeInstruction.
 * @author Roman Podolski - r.podolski@web.de, Janek Schoenwetter -
 *         janek.schoenwetter@yahoo.com
 */
@SuppressWarnings("serial")
public class IllegalAddressModeErrorException extends SyntaxErrorException {
	/**
	 * Constructor.
	 * @param strings
	 *            String description of the error, what caused the exception.
	 */
	public IllegalAddressModeErrorException(final String... strings) {
		super("The address mode doesn't match the expected norm: ", strings);
	}
}
