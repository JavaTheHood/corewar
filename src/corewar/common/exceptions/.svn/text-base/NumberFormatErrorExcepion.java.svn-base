...
/**
 * Exception class for a RedCode-linguistic error.
 * @author Roman Podolski, Janek Schoenwetter
 * @version 1.0
 */
@SuppressWarnings("serial")
public class NumberFormatErrorExcepion extends SyntaxErrorException {
	/**
	 * Constructor.
	 * @param strings
	 ...
	 *            exception.
	 */
	public NumberFormatErrorExcepion(final String... strings) {
		super("The address has to be a numeral litteral: ", strings);
	}
}
