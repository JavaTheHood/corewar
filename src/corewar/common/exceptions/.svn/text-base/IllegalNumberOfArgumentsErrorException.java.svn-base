...
/**
 * Exception class for an illegal number of arguments in a RedCode Instruction
 * object.
 * @author Roman Podolski, Janek Schoenwetter
 * @version 1.0
 */
@SuppressWarnings("serial")
public class IllegalNumberOfArgumentsErrorException extends
	 ...
	 *            exception.
	 */
	public IllegalNumberOfArgumentsErrorException(final String... strings) {
		super("The number of arguments doens't match the expected norm: ",
				strings);
	}
}
