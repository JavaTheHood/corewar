...
/**
 * Exception class for an invalid RedCode command.
 * @author Roman Podolski, Janek Schoenwetter
 * @version 1.0
 */
@SuppressWarnings("serial")

public class IllegalScopeErrorException extends SyntaxErrorException {
	/**
	 * Constructor.
	 * @param strings
	 ...
	 *            exception.
	 */
	public IllegalScopeErrorException(final String... strings) {
		super("Illegal scope: ", strings);
	}
