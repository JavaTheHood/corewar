...
public final class ParallelFileMars {
	 ...
	 *
	 * @param args
	 *            Kommandozeilenargumente. 1. Qualifizierter Klassenname einer
	 *            Mars-Implementierung. 2. Dezimalcode-Datei Programm 1. 3.
	 *            Weitere Dezimalcode-Datei Programm 2. 4. Protokoll-Datei
	 *            Simulation Programm 1 gegen Programm 2. 5. Weitere
	 *            Protokoll-Datei Simulation Programm 2 gegen Programm 1.
	 * @throws IOException
	 *             Fehler beim Lesen oder Schreiben eines Files.
	 * @throws ClassNotFoundException
	 *             Mars-Implementierung existiert nicht.
	 * @throws InstantiationException
	 *             Mars-Implementierung kann nicht instanziiert werden (kein
	 *             Def-Ctor?).
	 * @throws IllegalAccessException
	 *             Mars-Implementierung hat keinen public Def-Ctor.
	 */
	public static void main(final String[] args) throws IOException,
		...
		// get the Mars
		final MarsCore mars = (MarsCore) Class.forName(
				args[0].replace(File.separatorChar, '.')).newInstance();
		...
		final class BackgroundMarsRunner extends Thread {
			...
			/**
			 * Ctor setting everything up und auto-starting the thread. Usually
			 * bad style, but o.k. here, since the class is final.
			 *
			 * @param logFilenameArgsIndex
			 *            Index of logfile name in args array.
			 * @param codeFilenameArgIndex
			 *            Indices of compiled code filenames in args array.
			 * @exception IOException
			 *                Failure reading or writing files.
			 */
			public BackgroundMarsRunner(final int logFilenameArgsIndex,
					final int... codeFilenameArgIndex) throws IOException {
				// Wrap up everything in readers and writers, then fire off
				// simulation
